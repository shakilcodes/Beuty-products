...
const Login = () => {
    return (
        <div className='bg-[#E6F2FF] h-[91vh]'>
            <div className=' w-[450px] mx-auto pt-10 '>
                <div className='text-center bg-white py-10 rounded-xl'>
                    ...
                    <hr className='my-8'/>
                    <div>
                        <h1>Forgot Your Password? <span className='text-blue-500'><Link href=''>Reset Passowrd</Link></span></h1>
                        <p>New to Flick? <span className='text-blue-500'><Link href=''>Sign Up</Link></span></p>
                    </div>
                </div>

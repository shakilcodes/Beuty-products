    ...
    return (
        <div className='mt-[70px] lg:mt-[150px] lg:grid grid-cols-3 md:mx-20 gap-20'>
            ...
            <div className='px-5 my-10 lg:my-10 md:px-0 '>
                ...
                <p className='mt-10 border w-[300px] p-3 cursor-pointer hover:bg-gray-200'>Explore Offers</p>
            </div>
        </div>
    );
};

...
const SoapsForMD = () => {
    ...
    return (
        <div className='mx-20 lg:flex md:block hidden lg:hidden'>
            <div className='mt-20 '>
                <div className='lg:w-[400px]  px-5 md:px-0'><h5 className=''>For the body</h5>
            ...
            <div ref={sliderRef} className="keen-slider mt-20 lg:mt-[400px]">

...
const Aehenaeum = () => {
    return (
        <div className='grid grid-cols-[500px_68rem] ms-20 justify-between  gap-10 mt-[150px] text-[#333333]'>
            <div className=''>
            ...
            <div className=''>
                <img className='w-full h-[65vh]' src="https://i.postimg.cc/Hk4Zs5jn/Aesop-Article-Summer-Skin-Care-2020-Mid-1-Desktop-2560x1440px-1.jpg" alt="" />
            </div>
        </div>
    );
};

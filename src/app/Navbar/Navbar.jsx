                    ...
                    <div className="dropdown w-full">
                        <div className='flex items-center justify-between mr-5 text-white'>
                            <label tabIndex={0} className="btn btn-ghost lg:hidden">
                                ...
                                <Link className='block md:hidden' href=''>Aesop</Link>
                    ...
                    <ul >
                        <div className='flex justify-between items-center w-full gap-10'>
                            <div className='flex gap-3'>
                                <Link className='hidden md:block' href=''>Aesop</Link>
                                <Link href='' className=' hidden md:block'>Skin Care</Link>
                                <Link href='' className=' hidden md:block'>Body & Hand </Link>
                                <Link href='' className=' hidden md:block'>Fragrance </Link>
                                <Link href='' className=' hidden md:block'>Home </Link>
                                <Link href='' className=' hidden md:block'>Kits & Travel </Link>
                                <Link href='' className=' hidden md:block'>Gifts </Link>
                                <Link href='' className=' hidden md:block'>Read </Link>
                                <Link href='' className=' hidden md:block'>Stores </Link>
                                <Link href='' className=' hidden md:block'>Facial Appointments </Link>
                            ...
                            <div className='flex gap-3'>
                                ...
                                <Link href='' className=' hidden md:block'>Cabinet </Link>
                                <Link className='hidden md:block' href=''>Cart </Link>
                            </div>
